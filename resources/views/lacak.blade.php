                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md border-l-4 
                            ...
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-gray-800 mt-2">{{ Str::limit($pengaduan->isi_laporan, 100) }}</p>
                                    <p class="text-sm text-gray-500 mt-1">Dilaporkan pada: {{ $pengaduan->tanggal_laporan->format('d M Y, H:i') }}</p>
                                </div>
                                <div class="text-right">
                                    ...
                                    // [PERUBAHAN] Menambahkan warna untuk status baru
                                    elseif ($pengaduan->status == 'Diteruskan ke Penyidik') $statusClass = 'bg-green-100 text-green-800';
