                ...
                <div class="md:col-span-2 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            {{-- [PERUBAHAN UTAMA] Menambahkan data baru dan mengatur ulang urutan --}}
                            <dl class="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 text-sm">
                                ...
                                <dd class="text-gray-900">{{ $pengaduan->tempat_lahir ?? '' }}, {{ $pengaduan->tanggal_lahir ? $pengaduan->tanggal_lahir->format('d M Y') : '-' }}</dd>
