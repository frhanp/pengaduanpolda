                                ...
                                @forelse ($pengaduans as $pengaduan)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            {{-- Arahkan ke rute detail milik reskrim --}}
                                            <a href="{{ route('reskrim.dashboard.show', $pengaduan) }}" class="text-indigo-600 hover:text-indigo-900">Lihat Detail</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">
                                            Anda belum memiliki tugas laporan.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
